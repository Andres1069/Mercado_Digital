      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-5 py-3 sm:py-3.5 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-widest leading-none" style={{ color: "#94a3b8" }}>Mercado</p>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {menuMovil
                ...
                : <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
              }
            </button>
          </div>
        </div>
      ...
      <main style={{ backgroundColor: esOscuro ? "#0f172a" : "#ffffff" }}>
        ...
        >
          <div className="max-w-6xl mx-auto px-5">
            <div className="flex items-end justify-between gap-4 mb-8 flex-wrap">
              <div>
                <p className="text-xs uppercase tracking-[0.28em] font-bold mb-1" style={{ color: "#94a3b8" }}>Explorar</p>
                <h2 className="text-3xl md:text-4xl font-black" style={{ color: esOscuro ? "#f8fafc" : "#111827" }}>Categorias</h2>
              </div>
              <p className="text-sm" style={{ color: "#94a3b8" }}>Encuentra lo que buscas de forma rapida</p>
            </div>
            {categorias.length > 0 ? (
          ...
          <div className="max-w-6xl mx-auto px-5">
            ...
            <div className="mt-6 text-center">
              <p className="text-xs" style={{ color: esOscuro ? "#94a3b8" : "#9ca3af" }}>
                Todos los pagos son procesados de forma segura por MercadoPago. Tu informacion nunca es compartida.
              </p>
            </div>
          </div>
        </section>
