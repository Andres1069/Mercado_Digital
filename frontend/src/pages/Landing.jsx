...
function CategoriaCard({ cat, index }) {
  ...
  return (
    <Link to="/login"
      ...
      <div className="h-28 flex items-center justify-center text-4xl" style={{ backgroundColor: visual.top }}>
        {visual.icono}
      </div>
      <div className="p-4 flex flex-col flex-1">
        <p className="font-black text-[1.05rem] leading-tight" style={{ color: "#0f172a" }}>{cat.Nombre}</p>
